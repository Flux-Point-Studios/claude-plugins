...
```json graph-ir
{
  ...
  "budget": { "maxNodes": 40, "verifyFloorTokens": 40000, "nodeFloorTokens": 60000, "cacheTtl": "1h", "maxEstimatedTokens": 240000 },
...
cost one round. `maxEstimatedTokens` (240k) bounds the same worst case in
